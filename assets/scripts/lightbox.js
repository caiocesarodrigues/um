    ...
    function lightBoxx($galery,$image,$content){
        ...
        if (lightbox.config.buttonsExit) {
            $(lightbox.config.lightboxID).append(
                '<div class="exit">'+
                    '<p class="explosed"> FECHAR</p>'+
                    '<p class="more-profile">FECHAR</p>'+
                '</div>'
            );    
        }
                ...
                '<div class="prev">'+
                    '<div class="speaker-slide-arrow">'+
                        '<p class="link link--mallki">'+
                            'VOLTAR<span data-letters="VOLTAR"></span>'+
                            '<span data-letters="VOLTAR"></span>'+
                        '</p>'+
                    '</div>'+
                '</div>'+
                '<div class="next">'+
                    '<div class="speaker-slide-arrow">'+
                        '<p class="link link--mallki">'+
                            'PRÓXIMO<span data-letters="PRÓXIMO"></span>'+
                            '<span data-letters="PRÓXIMO"></span>'+
                        '</p>'+
                    '</div>'+
                '</div>');
